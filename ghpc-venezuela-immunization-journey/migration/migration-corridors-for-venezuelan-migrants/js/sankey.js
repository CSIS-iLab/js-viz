...
function renderChart(keys, data, colors) {
  Highcharts.chart('hcContainer', {
    ...
    subtitle: {
      text: 'As of 2021, more than 5.5 million refugees, asylum seekers, and Venezuelans displaced abroad had left for other countries, with nearly 4.5 million settling in Colombia, Peru, Ecuador, Chile, and United States. Hover over the color ribbons to see how many Venezuelans settled in each of the countries below.',
      align: 'left',
      style: {
        color: 'white',
      }
