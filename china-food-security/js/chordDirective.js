...
function ($window, matrixFactory) {
  ...
  var link = function ($scope, $el, $attr) {
    ...
    var colors = d3.scale.ordinal()
      .range(['#729897','#a3a5a7','#a3bcc3','#72aa8b','#406E79','#7695c4','#3b75bb','#534a6e','#887395','#798288','#907562','#772131','#ba3935','#e37b5c','#b77685','#c7b299', '#caac4c', '#2B242A','#918A59','#6E676C','#6E4752','#6B4A2F','#998476','#8A968D','#968D8A','#968D96','#CC855C', '#967860','#929488','#949278','#A0A3BD','#BD93A1','#65666B','#6B5745','#6B6664','#695C52','#56695E','#69545C','#565A69','#696043','#63635C','#636150','#333131','#332820','#302D30','#302D1F','#2D302F','#CFB6A3','#362F2A']);
