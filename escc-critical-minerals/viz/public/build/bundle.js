...
var app = (function () {
    ...
    */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(text_1, file$2, 88, 8, 3037);
    			attr_dev(g, "class", "title");
    			add_location(g, file$2, 87, 6, 3011);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$2, 77, 8, 2669);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file$2, 101, 10, 3425);
    			attr_dev(text_1, "x", /*padding*/ ctx[11].left - 5);
    			attr_dev(text_1, "y", "+4");
    			add_location(text_1, file$2, 103, 10, 3581);
    			...
    			add_location(g, file$2, 100, 8, 3345);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line1, file$2, 113, 6, 3831);
    			...
    			add_location(text1, file$2, 126, 6, 4289);
    			attr_dev(g1, "class", "axis x-axis");
    			add_location(g1, file$2, 112, 4, 3801);
    			attr_dev(svg, "class", "chart");
    			add_location(svg, file$2, 72, 2, 2495);
    			add_location(figure_1, file$2, 70, 0, 2413);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (58:4) {#each legendValues as d, legendIndex}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:4) {#each legendValues as d, legendIndex}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$1, 56, 2, 1564);
    			attr_dev(figure_1, "class", "interactive__color-legend legend");
    			add_location(figure_1, file$1, 45, 0, 1157);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { selectedIndicator } = $$props;
    	let colorScale = ['#1A6CC4', '#00B2E3', '#F4BE43', '#D84B29', '#45B166', '#C5C5C5'];
