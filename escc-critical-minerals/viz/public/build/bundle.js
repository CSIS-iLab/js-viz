...
var app = (function () {
    ...
    */
    ...
    // (72:4) {#each data.mineralData as country}
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$2, 72, 6, 2594);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each data.mineralData as country}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file$2, 80, 10, 3031);
    			attr_dev(text_1, "x", /*padding*/ ctx[10].left - 4);
    			attr_dev(text_1, "y", "+4");
    			add_location(text_1, file$2, 81, 10, 3099);
    			attr_dev(g, "class", g_class_value = "tick tick-" + /*tick*/ ctx[14]);
    			attr_dev(g, "transform", g_transform_value = "translate(0, " + /*yScale*/ ctx[6](/*tick*/ ctx[14]) + ")");
    			add_location(g, file$2, 79, 8, 2951);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*yTicks*/ 16 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[14])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(79:6) {#each yTicks as tick}",
    		ctx
    	});
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*xTicks*/ 32 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[14])) {
    				attr_dev(g, "class", g_class_value);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(91:6) {#each xTicks as tick}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 63, 0, 2382);
    			...
    			add_location(line1, file$2, 89, 6, 3329);
    			attr_dev(text1, "class", "xAxisTitle");
    			attr_dev(text1, "x", text1_x_value = /*width*/ ctx[1] / 2);
    			attr_dev(text1, "y", text1_y_value = /*height*/ ctx[2] - 4);
    			add_location(text1, file$2, 96, 6, 3731);
    			attr_dev(g1, "class", "axis x-axis");
    			add_location(g1, file$2, 88, 4, 3299);
    			attr_dev(svg, "class", "chart");
    			add_location(svg, file$2, 67, 2, 2438);
    			add_location(figure_1, file$2, 65, 0, 2405);
    		},
