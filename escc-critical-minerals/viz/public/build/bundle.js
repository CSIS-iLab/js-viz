...
var app = (function () {
    ...
    */
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "x1", /*padding*/ ctx[11].left);
    			attr_dev(line, "x2", line_x__value_1 = /*xScale*/ ctx[10](100));
    			add_location(line, file$2, 87, 10, 3011);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_2(ctx) {
    	...
    	let if_block = /*i*/ ctx[23] !== 0 && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file$2, 85, 10, 2919);
    			attr_dev(text_1, "x", /*padding*/ ctx[11].left - 5);
    			attr_dev(text_1, "y", "+4");
    			add_location(text_1, file$2, 89, 10, 3106);
    			attr_dev(g, "class", g_class_value = "tick tick-" + /*tick*/ ctx[19]);
    			attr_dev(g, "transform", g_transform_value = "translate(0, " + /*yScale*/ ctx[9](/*tick*/ ctx[19]) + ")");
    			add_location(g, file$2, 84, 8, 2839);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (/*i*/ ctx[23] !== 0) if_block.p(ctx, dirty);
    			if (dirty & /*yTicks*/ 128 && t_value !== (t_value = /*tick*/ ctx[19] + "")) set_data_dev(t, t_value);

    			if (dirty & /*yTicks*/ 128 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[19])) {
    				attr_dev(g, "class", g_class_value);
    			}

    			if (dirty & /*yScale, yTicks*/ 640 && g_transform_value !== (g_transform_value = "translate(0, " + /*yScale*/ ctx[9](/*tick*/ ctx[19]) + ")")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:6) {#each yTicks as tick, i}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file$2, 106, 10, 3612);
    			attr_dev(text_1, "y", text_1_y_value = /*height*/ ctx[3] - /*padding*/ ctx[11].bottom + 14);
    			add_location(text_1, file$2, 109, 10, 3726);
    			attr_dev(g, "class", g_class_value = "tick tick-" + /*tick*/ ctx[19]);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*xScale*/ ctx[10](/*tick*/ ctx[19]) + ",0)");
    			add_location(g, file$2, 105, 8, 3533);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*xTicks*/ 256 && t_value !== (t_value = /*tick*/ ctx[19] + "")) set_data_dev(t, t_value);

    			if (dirty & /*height*/ 8 && text_1_y_value !== (text_1_y_value = /*height*/ ctx[3] - /*padding*/ ctx[11].bottom + 14)) {
    				attr_dev(text_1, "y", text_1_y_value);
    			}

    			if (dirty & /*xTicks*/ 256 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[19])) {
    				attr_dev(g, "class", g_class_value);
    			}

    			if (dirty & /*xScale, xTicks*/ 1280 && g_transform_value !== (g_transform_value = "translate(" + /*xScale*/ ctx[10](/*tick*/ ctx[19]) + ",0)")) {
    				attr_dev(g, "transform", g_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:6) {#each xTicks as tick}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(text_1, file$2, 136, 8, 4652);
    			attr_dev(g, "class", "title");
    			add_location(g, file$2, 135, 6, 4626);
    		},
    		m: function mount(target, anchor) {
    ...
    // (123:6) {#each data.mineralData as country}
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "cx", circle_cx_value = /*xScale*/ ctx[10](/*country*/ ctx[16].percentProduction));
    			attr_dev(circle, "cy", circle_cy_value = "" + (/*yScale*/ ctx[9](/*country*/ ctx[16].percentReserves) + "px"));
    			attr_dev(circle, "r", "4px");

    			attr_dev(circle, "data-color", circle_data_color_value = /*selectedIndicator*/ ctx[1] === 'income_level'
    			? `${/*country*/ ctx[16].income_level}`
    			: `${/*country*/ ctx[16].region}`);

    			add_location(circle, file$2, 123, 8, 4109);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, circle, anchor);

    			if (!mounted) {
    				dispose = action_destroyer(tippy_action = tippy.call(null, circle, /*formatTooltip*/ ctx[12](/*country*/ ctx[16])));
    				mounted = true;
    			}
    		},
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*xScale, data*/ 1025 && circle_cx_value !== (circle_cx_value = /*xScale*/ ctx[10](/*country*/ ctx[16].percentProduction))) {
    				attr_dev(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*yScale, data*/ 513 && circle_cy_value !== (circle_cy_value = "" + (/*yScale*/ ctx[9](/*country*/ ctx[16].percentReserves) + "px"))) {
    			...
    			if (tippy_action && is_function(tippy_action.update) && dirty & /*data*/ 1) tippy_action.update.call(null, /*formatTooltip*/ ctx[12](/*country*/ ctx[16]));
    		},
    		i: function intro(local) {
    			if (!circle_intro) {
    				add_render_callback(() => {
    					circle_intro = create_in_transition(circle, fly, {
    						x: -/*xScale*/ ctx[10](/*country*/ ctx[16].percentProduction) + /*padding*/ ctx[11].left,
    						duration: 400 + 600 * (/*country*/ ctx[16].percentProduction / 10),
    						opacity: .5,
    						easing: quintOut
    					});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(123:6) {#each data.mineralData as country}",
    		ctx
    	});
    ...
    function create_key_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "key",
    		source: "(122:6) {#key selectedIndicator}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line0, file$2, 78, 6, 2657);
    			attr_dev(text0, "class", "yAxisTitle");
    			attr_dev(text0, "x", text0_x_value = -/*height*/ ctx[3] / 2);
    			attr_dev(text0, "y", /*padding*/ ctx[11].left - 28);
    			add_location(text0, file$2, 92, 6, 3189);
    			attr_dev(g0, "class", "axis y-axis");
    			add_location(g0, file$2, 77, 4, 2627);
    			...
    			add_location(line1, file$2, 99, 6, 3356);
    			...
    			add_location(text1, file$2, 112, 6, 3814);
    			attr_dev(g1, "class", "axis x-axis");
    			add_location(g1, file$2, 98, 4, 3326);
    			attr_dev(svg, "class", "chart");
    			add_location(svg, file$2, 74, 2, 2582);
    			add_location(figure_1, file$2, 72, 0, 2500);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*yTicks, yScale, padding, xScale*/ 3712) {
