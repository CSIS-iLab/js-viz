...
var app = (function () {
    ...
    */
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "x2", line_x__value_1 = /*xScale*/ ctx[10](100));
    			add_location(line, file$2, 93, 10, 3132);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, line, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScale*/ 1024 && line_x__value_1 !== (line_x__value_1 = /*xScale*/ ctx[10](100))) {
    ...
    function create_each_block_2(ctx) {
    	...
    	let if_block = /*i*/ ctx[24] !== 0 && create_if_block_2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file$2, 91, 10, 3040);
    			attr_dev(text_1, "x", /*padding*/ ctx[12].left - 5);
    			attr_dev(text_1, "y", "+4");
    			add_location(text_1, file$2, 95, 10, 3227);
    			attr_dev(g, "class", g_class_value = "tick tick-" + /*tick*/ ctx[20]);
    			attr_dev(g, "transform", g_transform_value = "translate(0, " + /*yScale*/ ctx[9](/*tick*/ ctx[20]) + ")");
    			add_location(g, file$2, 90, 8, 2960);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*yTicks*/ 128 && t_value !== (t_value = /*tick*/ ctx[20] + "")) set_data_dev(t, t_value);

    			if (dirty & /*yTicks*/ 128 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[20])) {
    				attr_dev(g, "class", g_class_value);
    			}

    			if (dirty & /*yScale, yTicks*/ 640 && g_transform_value !== (g_transform_value = "translate(0, " + /*yScale*/ ctx[9](/*tick*/ ctx[20]) + ")")) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line, file$2, 112, 10, 3733);
    			attr_dev(text_1, "y", text_1_y_value = /*height*/ ctx[3] - /*padding*/ ctx[12].bottom + 14);
    			add_location(text_1, file$2, 115, 10, 3847);
    			attr_dev(g, "class", g_class_value = "tick tick-" + /*tick*/ ctx[20]);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*xScale*/ ctx[10](/*tick*/ ctx[20]) + ",0)");
    			add_location(g, file$2, 111, 8, 3654);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*xTicks*/ 256 && t_value !== (t_value = /*tick*/ ctx[20] + "")) set_data_dev(t, t_value);

    			if (dirty & /*height*/ 8 && text_1_y_value !== (text_1_y_value = /*height*/ ctx[3] - /*padding*/ ctx[12].bottom + 14)) {
    				attr_dev(text_1, "y", text_1_y_value);
    			}

    			if (dirty & /*xTicks*/ 256 && g_class_value !== (g_class_value = "tick tick-" + /*tick*/ ctx[20])) {
    				attr_dev(g, "class", g_class_value);
    			}

    			if (dirty & /*xScale, xTicks*/ 1280 && g_transform_value !== (g_transform_value = "translate(" + /*xScale*/ ctx[10](/*tick*/ ctx[20]) + ",0)")) {
    				attr_dev(g, "transform", g_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block$1(ctx) {
    	...
    	let t;
    	let text_1_x_value;
    	let if_block = /*circles*/ ctx[11] && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(text_1, file$2, 144, 8, 4805);
    			attr_dev(g, "class", "title");
    			add_location(g, file$2, 143, 6, 4779);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (/*circles*/ ctx[11]) if_block.p(ctx, dirty);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "cx", circle_cx_value = /*xScale*/ ctx[10](/*country*/ ctx[17].percentProduction));
    			attr_dev(circle, "cy", circle_cy_value = "" + (/*yScale*/ ctx[9](/*country*/ ctx[17].percentReserves) + "px"));
    			attr_dev(circle, "r", "4px");

    			attr_dev(circle, "data-color", circle_data_color_value = /*selectedIndicator*/ ctx[1] === 'income_level'
    			? `${/*country*/ ctx[17].income_level}`
    			: `${/*country*/ ctx[17].region}`);

    			add_location(circle, file$2, 130, 8, 4250);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, circle, anchor);

    			if (!mounted) {
    				dispose = action_destroyer(tippy_action = tippy.call(null, circle, /*formatTooltip*/ ctx[13](/*country*/ ctx[17])));
    				mounted = true;
    			}
    		},
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*xScale, data*/ 1025 && circle_cx_value !== (circle_cx_value = /*xScale*/ ctx[10](/*country*/ ctx[17].percentProduction))) {
    				attr_dev(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*yScale, data*/ 513 && circle_cy_value !== (circle_cy_value = "" + (/*yScale*/ ctx[9](/*country*/ ctx[17].percentReserves) + "px"))) {
    			...
    			if (tippy_action && is_function(tippy_action.update) && dirty & /*data*/ 1) tippy_action.update.call(null, /*formatTooltip*/ ctx[13](/*country*/ ctx[17]));
    		},
    		i: function intro(local) {
    			if (!circle_intro) {
    				add_render_callback(() => {
    					circle_intro = create_in_transition(circle, fly, {
    						x: -/*xScale*/ ctx[10](/*country*/ ctx[17].percentProduction) + /*padding*/ ctx[12].left,
    						duration: 400 + 600 * (/*country*/ ctx[17].percentProduction / 10),
    						opacity: .5,
    						easing: quintOut
    					});
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*xScale, data, yScale, selectedIndicator, formatTooltip*/ 9731) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line1, file$2, 105, 6, 3477);
    			...
    			add_location(text1, file$2, 118, 6, 3935);
    			attr_dev(g1, "class", "axis x-axis");
    			add_location(g1, file$2, 104, 4, 3447);
    			attr_dev(svg, "class", "chart");
    			add_location(svg, file$2, 80, 2, 2703);
    			add_location(figure_1, file$2, 78, 0, 2621);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*yTicks, yScale, padding, xScale*/ 5760) {
    				each_value_2 = /*yTicks*/ ctx[7];
    				validate_each_argument(each_value_2);
    				let i;
    			...
    			if (dirty & /*xTicks, xScale, height, padding*/ 5384) {
    ...
    `;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('circles' in $$props) $$invalidate(11, circles = $$props.circles);
